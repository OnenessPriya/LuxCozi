...
@php
$storename = \App\Models\Team::where('store_id', $data->stores->id)->with('distributors','rsm','zsm','nsm','asm','sm','ase')->first();
@endphp
<section>
    <div class="row">
        <div class="col-sm-12">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6 text-end">
                            <a href="{{ route('admin.stores.index') }}" class="btn btn-danger">
							 ...
							 @if($data->stores->zsm_approval == 1)
                                            <a href="{{ route('admin.stores.status', $data->stores->id) }}">{{($data->stores->status == 1) ? 'Active' : 'Inactive'}}</a>
