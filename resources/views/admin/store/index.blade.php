    ...
    <div class="card card-body">
        <div class="search__filter mb-0">
            <div class="row align-items-center">
                ...
                <div class="col-md-3">
                    <a class="btn btn-danger btn-sm" href="{{ route('admin.store.inactive',['status' => '0']) }}">Inactive Store ({{$inactiveStore->count()}})</a>
					
                </div>
				
                <div class="col-md-12 text-end">
                    <form class="row align-items-end justify-content-end" action="{{ route('admin.store.index') }}">
						<div class="col-auto">
                        ...
                        <div class="col-auto">
                            ...
                            <select class="form-control form-control-sm select2" id="distributor" name="distributor">
                                ...
                                @foreach ($allDistributors as $item)
                                    <option value="{{$item->bussiness_name}}" {{ (request()->input('distributor') == $item->bussiness_name) ? 'selected' : '' }}>{{$item->bussiness_name}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-auto">
                        ...
                        <div class="col-auto">
                            <div class="btn-group">
                                ...
                                <a href="{{ route('admin.store.export.csv', ['date_from'=>$request->date_from,'date_to'=>$request->date_to,'ase'=>$request->ase,'distributor'=>$request->distributor,'state'=>$request->state,'area'=>$request->area,'keyword'=>$request->keyword]) }}" class="btn btn-sm btn-danger" data-bs-toggle="tooltip" title="Export data in CSV">
