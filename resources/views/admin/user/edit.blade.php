...
@section('content')
@php
$distributorTeam=\App\Models\Team::select('id','nsm_id','zsm_id','rsm_id','sm_id','asm_id','ase_id','distributor_id','state_id','area_id')->where('distributor_id',$data->id)->groupBy('ase_id')->paginate(50);
